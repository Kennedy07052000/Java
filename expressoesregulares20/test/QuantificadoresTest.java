...
public class QuantificadoresTest {
    public static void main(String[] args) {
        ...
        String regex = "0[xX]([0-9a-fA-F])+(\\s|$)"; //tem que começar com 0, seguido de x ou X, seguido desses valores do intervalo que pode ter um ou mais([0-9a-fA-F])+, seguido de um espaço em branco ou fim de linha
